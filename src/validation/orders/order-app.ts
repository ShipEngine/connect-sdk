import { AppType, ErrorCode, GetSalesOrdersByDate, OrderApp as IOrderApp, OrderAppPOJO, SalesOrderShipmentPOJO, SalesOrderTimeRangePOJO, ShipmentCancelled, ShipmentCreated, TransactionPOJO } from "../../definitions";
