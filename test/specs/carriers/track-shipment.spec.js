  ...
  describe("Failure tests", () => {
    ...
    it("should throw an error if nothing is returned", async () => {
      ...
      try {
        ...
        expect(error.message).to.equal("Error in the trackShipment method. Invalid tracking info: A value is required");
      }
    });
    ...
    it("should throw an error if an invalid package is returned", async () => {
      ...
      try {
        ...
        expect(error.message).to.equal("Error in the trackShipment method. Invalid tracking info: packages[0].package is not allowed, packages[0].dimension is not allowed");
      }
    });
    ...
    it("should throw an error if the event is invalid", async () => {
      ...
      try {
        ...
        expect(error.message).to.equal("Error in the trackShipment method. Invalid tracking info: events[0].note is not allowed");
      }
    });
  });
});
